# ==============================================================================
# 03_global_absolute_trends_summary.R — Global mean absolute greening
# ==============================================================================
...
if (nrow(area) != 720L ||
  ncol(area) != 1440L) {
  stop("Area raster has unexpected dimensions")
}
...
write_csv(
  ...
  file.path(
    outdir,
    "table_global_mean_absolute_trends_yearmean_LAI_overview.csv"
  )
)
# Full overview
write_csv(
