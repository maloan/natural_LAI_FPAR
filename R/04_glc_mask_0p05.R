## =============================================================================
# 04_glc_used_0p05.R — Build “used ≥ N years” mask from GLC yearstack
...
cfg <- cfg_read()
opts <- opts_read()
terraOptions(progress = 1, todisk = TRUE, memfrac = 0.25)
...
if (!is.finite(N_YEARS) || N_YEARS < 1) stop("USED_N_YEARS must be a positive integer")
